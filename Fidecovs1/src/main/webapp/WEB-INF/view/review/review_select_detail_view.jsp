...
<div class="card-body">
    <div class="row pl-1 pr-1">
        <div class="col col-md-10">
          ...
          <td colspan="2">${reviewDTO.review_id} </td>
          </tr>
        	<tr>
          <td style="background-color: #eeeeee;">제목 </td>
          <td colspan="2">${reviewDTO.review_title} </td>
          </tr>
          <tr>
          <td style="background-color: #eeeeee;">내용 </td>
          <td colspan="2" style="min-height: 200px; text-align: center;">${reviewDTO.review_content} </td>
          </tr>
          </table> 
           </div>
  	</div>
